...
class SearchResultItem(var rush_id: String?, var title: String?, var author: String?, var rating: String?, var est_time: String?, var pages: String?, var audio: Any?, var video: Any?, var description: String?, var cover: String?, var genre: String?, var attr: String?, var url: Any?, var cost: String?, var type: String?, var datetime: String?)